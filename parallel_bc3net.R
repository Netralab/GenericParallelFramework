...
file_path = "address of the dataset file"
...
#### BC3NET
func_bc3net <- function(ds)
{
  ds = t(ds)
  res <- bc3net(ds, estimator="pearson",weighted=FALSE, igraph=FALSE, verbose=FALSE)
...
write.table(adj_matrix, file=paste("output file folder address","bc3net_4000", sep = "_"), quote=FALSE, sep='\t')
# done

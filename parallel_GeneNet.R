...
func_gnet<- function(ds)
{
  col_name_ds = colnames(ds)
  result <- func_GeneNet(ds)
  res <- result
...
write.table(adj_matrix, file=paste("Output folder address","genenet_4000", sep = "_"), quote=FALSE, sep='\t')
# done

...
#### C3MTC
func_c3mtc <- function(ds)
{
  ds = t(ds)
  res <- c3mtc(ds,mtc=TRUE, adj="bonferroni", estimator="pearson", disc="none", adjacency=TRUE, igraph=FALSE)
  return(res)
}
# end of C3MTC
...
write.table(adj_matrix, file=paste("output folder address","c3mtc_4000", sep = "_"), quote=FALSE, sep='\t')
# done

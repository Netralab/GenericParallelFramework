...
#3. MRNET
func_mrnet <- function(ds)
{
  result <- minet(ds, method="mrnet", estimator="spearman")
  res <- result[,-1][-1,]
...
write.table(adj_matrix, file=paste("output folder address","mrnet_4000", sep = "_"), quote=FALSE, sep='\t')
# done

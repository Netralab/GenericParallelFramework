...
file_path = "address of the dataset"
...
write.table(adj_matrix, file=paste("output folder address","genie3_4000", sep = "_"), quote=FALSE, sep='\t')
# done

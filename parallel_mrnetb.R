...
#5. MRNETB
func_mrnetb <- function(ds)
{
  result <- minet(ds, method="mrnetb", estimator="spearman")
  res <- result[,-1][-1,]
...
write.table(adj_matrix, file=paste("output folder address","mrnetb_4000", sep = "_"), quote=FALSE, sep='\t')
# done
